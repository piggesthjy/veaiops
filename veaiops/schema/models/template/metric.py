...
class MetricTemplateValue(BaseModel):
    ...
    max_value: float = Field(default=100.0, description="Maximum Value")
    ...
    normal_range_start: float = Field(default=10.0, description="Normal Range Start")
    normal_range_end: float = Field(default=90.0, description="Normal Range End")
