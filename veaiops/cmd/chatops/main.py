...
if __name__ == "__main__":
    ...
    # allow running with `python -m veaiops.cmd.chatops.main` for local debug
    import uvicorn

    uvicorn.run("veaiops.cmd.chatops.main:app", host="0.0.0.0", port=6000, reload=True)
