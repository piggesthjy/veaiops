...
"""Tests for intelligent_threshold main application."""

from fastapi.testclient import TestClient

from veaiops.cmd.intelligent_threshold.main import app


def test_get_app_creation():
    """Test that get_app function creates FastAPI app successfully."""
    from veaiops.cmd.intelligent_threshold.main import get_app

    app = get_app()
    assert app.title == "VeAIOp-IntelligentThreshold"
